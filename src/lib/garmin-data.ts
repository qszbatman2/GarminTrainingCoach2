  ...
  return {
    ...
    averageCadence: firstNumber(
      [
        ...
        "summaryDTO.averageBikeCadenceInRevPerMinute",
        ...
        "split_summaries.*.averageBikeCadenceInRevPerMinute",
        "split_summaries.*.averageBikingCadenceInRevPerMinute",
        "split_summaries.*.averageCadence",
        "laps.*.averageBikeCadence",
        "laps.*.averageBikeCadenceInRevPerMinute",
        "laps.*.averageBikingCadenceInRevPerMinute",
        "laps.*.averageCadence",
      ],
      raw
    ),
