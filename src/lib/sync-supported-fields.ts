...
export const SUPPORTED_FIELD_GROUPS: SupportedFieldGroup[] = [
  {
    ...
    fields: [
      { id: "sleepScore", label: "睡眠评分", metricPaths: ["sleep.dailySleepDTO.sleepScores.overall.value", "sleep.sleepScores.overall.value"] },
      {
        id: "sleepDuration",
        label: "睡眠时长",
        metricPaths: ["sleep.dailySleepDTO.sleepTimeSeconds", "sleep.sleepTimeSeconds", "sleep.totalSleepSeconds", "sleep.sleepDurationSeconds", "stats.measurableAsleepDuration"],
      },
      ...
      },
      {
        id: "awakeDuration",
        label: "清醒时长",
        metricPaths: ["sleep.dailySleepDTO.awakeSleepSeconds", "sleep.awakeSleepSeconds", "sleep.awakeTimeSeconds", "sleep.awakeDurationInSeconds", "stats.measurableAwakeDuration"],
      },
  ...
  },
  {
    ...
    fields: [
      ...
      {
        id: "bodyBatterySeries",
        label: "Body Battery 分时",
        metricPaths: ["stress.bodyBatteryValuesArray", "body_battery.bodyBatteryValuesArray", "body_battery.bodyBatteryValues"],
      },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "restingCalories", label: "静息消耗", metricPaths: ["stats.bmrKilocalories", "stats.bmrCalories", "stats.restingCalories"] },
      ...
      },
      {
        id: "moderateVigorous",
        label: "中高强度分钟",
        metricPaths: ["intensity_minutes.moderateIntensityMinutes", "intensity_minutes.vigorousIntensityMinutes", "stats.moderateIntensityMinutes", "stats.vigorousIntensityMinutes"],
      },
      { id: "floors", label: "爬楼层数", metricPaths: ["stats.floorsAscended", "floors.totalFloorsClimbed", "floors.floorsAscended", "stats.floorsClimbed"] },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        id: "recoveryHours",
        label: "建议恢复时长",
        metricPaths: ["training_status_aggregated.recoveryTime", "training_status.recoveryTime", "training_status.recoveryHours", "training_status.mostRecentTrainingStatus.latestTrainingStatusData.*.recoveryTime"],
      },
      {
        id: "vo2Max",
        label: "VO2 Max",
        metricPaths: ["max_metrics.vo2Max", "max_metrics.cyclingVo2Max", "training_status.mostRecentVO2Max.generic.vo2MaxValue", "training_status.mostRecentVO2Max.cycling.vo2MaxValue"],
      },
      {
...
function hasDataAtPaths(source: unknown, paths?: string[]) {
  ...
  return paths.some((path) => getValuesByPath(source, path).some((value) => hasMeaningfulValue(value)))
}
