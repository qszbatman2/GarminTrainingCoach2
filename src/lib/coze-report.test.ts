  ...
  context: {
    ...
    weeklyAssessment: {
      ...
      load: {
        ...
        sessions: {
          actual: 2,
          recent4WeekSameProgressAverage: 2,
          expectedToDate: 2,
          projectedWeekTotal: 3.5,
          monthWeeklyAverage: 3,
          sameProgressRatio: 1,
      ...
      intensity: {
        ...
        totals: {
          ...
          avgAerobicEffect: 2.4,
          avgAnaerobicEffect: 0.4,
        },
        trainingLoad: {
          actual: 180,
        ...
        intensityMinutes: {
          actual: 80,
          recent4WeekSameProgressAverage: 72,
          expectedToDate: 70,
          projectedWeekTotal: 140,
          monthWeeklyAverage: 120,
          sameProgressRatio: 1.11,
          weeklyAverageRatio: 1.17,
        },
        ...
        avgAerobicEffect: { actual: 2.4, monthAverage: 2.2, ratio: 1.09 },
        avgAnaerobicEffect: { actual: 0.4, monthAverage: 0.3, ratio: 1.33 },
        score: 82,
        conclusion: "合理",
      },
      overall: {
      ...
      habit: {
        pattern: "分布均衡",
        recent4WeekCompletionRatio: 1,
        currentVsHabitRatio: 1.05,
        sameWeekdaySessionRate: 0.5,
        sameWeekdayAverageDurationMin: 60,
